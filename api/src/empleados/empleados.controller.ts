import { Controller, Get, Post, Body, Patch, Param, Delete, ValidationPipe, Query, Req, BadRequestException, ParseIntPipe, HttpException, HttpStatus } from '@nestjs/common';
...
export class EmpleadosController {
    ...
    @Patch(':id_empleado')
    update(@Param('id_empleado', ParseIntPipe) id_empleado: number, @Body( new ValidationPipe() ) data: UpdateEmpleado) {
